...
#from .vame_utils import remove_bodypart
...
def csv_to_numpy(config, usage=True):
    """
    ...
    if cfg['egocentric_data'] == False and usage:
    ...
    for file in filename:
        ...
        if usage :
            ...
            yield file, frames, final_positions
